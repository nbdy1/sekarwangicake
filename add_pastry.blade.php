...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <h1 class="text-4xl text-primary font-bold mb-3">Add Pastry</h1>
        <form method="POST" enctype="multipart/form-data"
            ...
            <div class="flex flex-col gap-5.5 p-6.5">
                <div>
                    ...
                    <input autofocus value="{{ old('pastryName') }}" required id="pastryName" name="pastryName"
                        type="text" placeholder="Random Pastry Name"
                        class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary @error('pastryName') !border-danger @enderror" />
                    @error('pastryName')
                ...
                <div>
                    ...
                    <div class="flex flex-row gap-x-3"> <input value="{{ old('pastrySlug') }}" required
                            id="pastrySlug" name="pastrySlug" type="text" placeholder="Random Pastry Slug"
                            class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary  @error('pastrySlug') !border-danger @enderror" />
                ...
                <div>
                    ...
                    <textarea required name="pastryDescription" rows="6"
                        ...
                        class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary  @error('pastryDescription') !border-danger @enderror">{{ old('pastryDescription') }}</textarea>
                    @error('pastryDescription')
                        <div class="text-sm text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input value="{{ old('pastryPrice') }}" required name="pastryPrice" type="text"
                        placeholder="25000"
                        class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary @error('pastryPrice') !border-danger @enderror" />
                    @error('pastryPrice')
                        <div class="text-sm text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div x-data="{ switcherToggle: false }">
                    ...
                    <div x-show="switcherToggle">
                        ...
                        <input :required="switcherToggle" value="{{ old('pastryOriPrice') }}" name="pastryOriPrice"
                            type="text" placeholder="25000"
                            class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary @error('pastryOriPrice') !border-danger @enderror" />
                        @error('pastryOriPrice')
                            <div class="text-sm text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
