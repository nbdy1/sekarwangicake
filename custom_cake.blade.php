...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10 dark:bg-[#050505] ">
        ...
        <div class="flex-col flex mb-6 gap-y-3">
            <h1 class="text-6xl text-primary font-bold ">Custom Cakes</h1>
            <a href="{{ url('/admin/custom-cake/create') }}"
            ...
            <div class="max-w-full overflow-x-auto">
                <table class="w-full table-auto">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td class="py-5 px-4 pl-9 text-black dark:text-white text-center" colspan="4">No Custom
                                    Cakes
                                    Available</td>
                            </tr>
                        @endforelse
