...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            <div
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium">Total Simple Cake</span>
                    </div>
            ...
            <div
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium">Total Custom Cake</span>
                    </div>
            ...
            <div
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium">Total Pastry</span>
                    </div>
        ...
        <div class="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
            <!-- ====== Chart One Start -->
            {{-- <include src="./partials/chart-01.blade.php" /> --}}
            @include('admin.partials.chart-01')
            <!-- ====== Chart One End -->

            <!-- ====== Chart Two Start -->
            {{-- <include src="./partials/chart-02.blade.php" /> --}}
            @include('admin.partials.chart-02')
            <!-- ====== Chart Two End -->

            <!-- ====== Chart Three Start -->
            {{-- <include src="./partials/chart-03.blade.php" /> --}}
            @include('admin.partials.chart-03')
            <!-- ====== Chart Three End -->

            <!-- ====== Map One Start -->
            {{-- <include src="./partials/map-01.blade.php" /> --}}
            @include('admin.partials.map-01')
            <!-- ====== Map One End -->

            <!-- ====== Table One Start -->
            <div class="col-span-12 xl:col-span-8">
                {{-- <include src="./partials/table-01.blade.php" /> --}}
